  ...
  'inline-flex items-center gap-1 rounded-md border px-2 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        in_progress:
          'border-transparent bg-cyan-50 text-cyan-700 dark:bg-cyan-950/60 dark:text-cyan-300',
        ...
        high: 'border-transparent bg-fuchsia-50 text-fuchsia-600 dark:bg-fuchsia-950 dark:text-fuchsia-400',
        critical:
